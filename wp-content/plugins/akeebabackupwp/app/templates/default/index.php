	...
	<header class="akeeba-navbar">
		<div class="akeeba-maxwidth akeeba-flex">
			...
			<nav>
				...
				<?php if ($this->container->userManager->getUser()->getId()): ?>
					<a href="<?php echo $this->getContainer()->router->route('index.php?view=login&task=logout') ?>"
					   class="akeeba-btn--grey hasTooltip"
					   title="<?php echo Text::sprintf('SOLO_LOGIN_LBL_LOGOUT', $this->container->userManager->getUser()->getUsername()) ?>"
					   data-toggle="tooltip" data-placement="bottom">
						<span class="akion-log-out"></span>
						<span class="hidden-lg hidden-md hidden-sm"><?php echo Text::sprintf('SOLO_LOGIN_LBL_LOGOUT', $this->container->userManager->getUser()->getUsername()) ?></span>
					</a>
				<?php endif; ?>
			</nav>
		</div>
