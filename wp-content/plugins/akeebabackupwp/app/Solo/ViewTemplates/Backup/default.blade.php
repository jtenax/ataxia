...
<div id="backup-setup" class="akeeba-panel--primary">
	...
	@if($this->unwriteableOutput)
		<div id="akeeba-fatal-outputdirectory" class="akeeba-block--failure">
			...
			<p>
				@sprintf('COM_AKEEBA_BACKUP_ERROR_UNWRITABLEOUTPUT_COMMON', $router->route('index.php?view=configuration'), 'https://www.akeebabackup.com/warnings/q001.html')
			</p>
		</div>
	@endif
	...
	<form id="dummyForm" style="display: {{ $this->unwriteableOutput ? 'none' : 'block' }};" class="akeeba-form--horizontal" role="form">
		...
		@if($this->showJPSPassword)
			<div class="akeeba-form-group">
                ...
                <input type="password" name="jpskey" value="{{{ $this->jpsPassword }}}"
		...
		@if($this->showANGIEPassword)
			<div class="akeeba-form-group">
                ...
                <input type="password" name="angiekey" value="{{{ $this->ANGIEPassword }}}"
        ...
        <div id="errorframe">
            ...
            <div class="akeeba-block--info" id="error-panel-troubleshooting">
				<p>
					...
					@sprintf('COM_AKEEBA_BACKUP_TEXT_RTFMTOSOLVE', 'https://www.akeebabackup.com/documentation/troubleshooter/abwpbackup.html?utm_source=akeeba_backup&utm_campaign=backuperrorlink')
				</p>
				<p>
					@if(AKEEBABACKUP_PRO)
